      ...
      <section>
          ...
          <div class="col-9">
                <div class="tab-content" id="nav-tabContent">
                          ...
                          <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane active" id="settings">
                                <form role="form" method="post" action="{{ route('lyndrx.edit.profile') }}">
                                  @csrf
                                  <div class="row">
                  ...
                  <form role="form" method="post" action="{{ route('lyndrx.edit.password') }}">
                      @csrf
                  <div class="col-md-8">
                    <div class="form-group">
                      <label class="">Old Password</label class="text-danger">*</label></label>
                      <input type="password" class="form-control pull-right"  placeholder="Current Password" name="old_password" required>
                    <!-- /.input group -->
                    </div>
